...
//   @IsString()
//   MAILER_MAILGUN_DOMAIN_NAME: string;

//   @IsString()
//   MAILER_MAILGUN_DEFAULT_NAME: string;

//   @IsString()
//   MAILER_MAILGUN_DEFAULT_EMAIL: string;
// }
...
//     mailGunAPIKey: process.env.MAILER_MAILGUN_API_KEY,
//     mailGunDomainName: process.env.MAILER_MAILGUN_DOMAIN_NAME,
//     mailGunDefaultName: process.env.MAILER_MAILGUN_DEFAULT_NAME,
//     mailGunDefaultEmail: process.env.MAILER_MAILGUN_DEFAULT_EMAIL,
//   };
// });
